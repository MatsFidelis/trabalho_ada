...
| `evidence-manifest.json` | `generate_evidence_manifest.py` | hashes SHA-256 dos arquivos do bundle |
...
Para reproduzir localmente em modo simulado, execute `bash scripts/mock_release_artifacts.sh`, a política de licenças, a submissão mock do Dependency-Track, `python3 scripts/generate_evidence_manifest.py` e `python3 scripts/verify_evidence.py`.
